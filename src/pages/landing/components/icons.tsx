...
export function CalculatorIcon({ className = 'w-8 h-8' }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path
        strokeLinecap="round"
...
export function LockIcon({ className = 'w-8 h-8' }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path
        strokeLinecap="round"
...
export function CheckCircleOutlineIcon({ className = 'w-6 h-6' }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path
        strokeLinecap="round"
...
export function ChatGPTIcon({ className = 'w-4 h-4' }: IconProps) {
  return (
